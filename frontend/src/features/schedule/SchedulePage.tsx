                ...
                <div className="space-y-6">
                    <div className="glass rounded-3xl p-6 space-y-6 border border-brand-primary/10">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    <select className="w-full bg-bg-subtle border border-border-ui rounded-xl py-3 px-4 focus:outline-none focus:border-brand-primary transition-all appearance-none cursor-pointer text-sm">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="flex items-center gap-3">
                                    <button className="w-10 h-10 rounded-xl border border-border-ui flex items-center justify-center hover:bg-white/5 transition-colors">-</button>
                                    <div className="flex-1 bg-bg-subtle border border-border-ui rounded-xl py-2 px-4 text-center text-lg font-bold">5</div>
                                    <button className="w-10 h-10 rounded-xl border border-border-ui flex items-center justify-center hover:bg-white/5 transition-colors">+</button>
                                </div>
                            </div>
                        ...
                        <div className="pt-4 space-y-3">
                            <button className="w-full bg-brand-primary hover:bg-brand-primary/90 text-white font-bold py-3.5 rounded-xl glow-brand transition-all flex items-center justify-center gap-2">
                                <Save className="w-5 h-5" />
                                Save & Apply
                            </button>
                            <button className="w-full border border-border-ui hover:bg-white/5 text-text-secondary font-bold py-3.5 rounded-xl transition-all">
                                Reset Draft
                            </button>
                        </div>
                    </div>
