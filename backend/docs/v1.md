...
│       ├── entity/ AmazonCredential.java, TelegramCredential.java, UserProfile.java
│       └── util/EncryptionUtil.java      ← AES-256 encrypt/decrypt
│
├── scheduler-service/              ← :8083
│   └── src/main/java/
│       ├── controller/
...
│       │   └── QuartzJobManagerService.java
│       ├── job/PostingJob.java           ← Quartz Job implementation
│       └── client/FetcherClient.java
│
├── fetcher-service/                ← :8084
│   └── src/main/java/
│       ├── controller/InternalFetchController.java
│       ├── service/
│       │   ├── ProductFetchService.java
│       │   ├── ProductCacheService.java
│       │   ├── ProductSelectionService.java
│       │   └── AmazonApiClient.java       ← PA API 5.0 with AWS Sig V4
│       └── client/PusherClient.java
│
├── pusher-service/                 ← :8085
│   └── src/main/java/
│       ├── controller/InternalPushController.java
│       └── service/
